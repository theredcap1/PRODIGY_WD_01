            ...
            <div className="container px-0 mx-auto lg:px-20 relative w-full">
                <div className="flex justify-between items-center">
                    <div className="flex w-full items-center flex-shrink-0 justify-between px-8 gap-24 lg:w-fit">
                        <img src={logo} alt="" className="h-12 w-auto cursor-pointer"/>
                    ...
                    <div
                        className="absolute lg:static lg:min-h-fit lg:w-auto lg:bg-transparent bg-neutral-800 top-[-100vh] pt-8 pb-8 lg:pt-0 lg:pb-0 transition-all duration-400 text-center w-full" id="nav-buttons">
                        <ul className="flex flex-col lg:flex-row justify-between items-center md:gap-[4vw] gap-12">
                            {elements.map((element, index) => (
                                <li key={index} className="text-white cursor-pointer transition-all hover:text-neutral-300 duration-300">{element}</li>
                            ))}
                        </ul>
                    </div>
                </div>
